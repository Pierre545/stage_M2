...
## Pretraitement et application de l'ACP à la matrice / module scikit
...
PCs  = pca.transform(matrice_scale)
...
## Pretraitement et application de l'ACP à la matrice / module eofs
...
#Affichage du premier EOFs de la matrice bis et de la matrice d'origine
...
ax1.set_title('EOF 1 de matrice')
ax2.set_title('EOF 1 de matrice_diff')
